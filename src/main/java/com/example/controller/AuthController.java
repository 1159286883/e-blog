...
public class AuthController extends BaseController {
    ...
    public Result doRegister(MUser muser, String repass, String vercode) {

        ValidationUtil.ValidResult validResult = ValidationUtil.validateBean(muser);
        if(validResult.hasErrors()) {
            return Result.fail(validResult.getErrors());
        }

        if(!muser.getPassword().equals(repass)) {
